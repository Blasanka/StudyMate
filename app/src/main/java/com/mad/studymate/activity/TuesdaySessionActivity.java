...
public class TuesdaySessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuesday_session);
        ...
        sessionCardAdapter.setOnItemClickListener(new SessionCardAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(TuesdaySessionActivity.this, ViewSessionActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TuesdaySessionActivity.this, AddSessionActivity.class);
                startActivity(intent);
            }
        });
    }
