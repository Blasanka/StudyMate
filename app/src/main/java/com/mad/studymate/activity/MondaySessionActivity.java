...
public class MondaySessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monday_session);

        actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle("Monday Study Sessions");
        ...
        sessionCardAdapter.setOnItemClickListener(new SessionCardAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(MondaySessionActivity.this, ViewSessionActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MondaySessionActivity.this, AddSessionActivity.class);
                startActivity(intent);
            }
        });
    }
