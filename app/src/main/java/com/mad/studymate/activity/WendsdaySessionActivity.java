...
public class WendsdaySessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wendsday_session);

        actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle("Tuesday Study Sessions");
        ...
        sessionCardAdapter.setOnItemClickListener(new SessionCardAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(WendsdaySessionActivity.this, ViewSessionActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WendsdaySessionActivity.this, AddSessionActivity.class);
                startActivity(intent);
            }
        });
    }
